...
export class DeliveryPersonService {
    ...
    async getAllDeliveryPersons(status?: string, page: number = 1, limit: number = 10): Promise<{ data: DeliveryPersonResponse[], meta: { total: number, page: number, limit: number }, totalRows: number }> {
    ...
    async getDeliveryPersonById(id: string): Promise<DeliveryPerson> {
